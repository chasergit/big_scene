...
vec3 lightPosition=vec3(60.0,100.0,60.0)*100.0;
...
fogFactor=smoothstep(50.0,1000.0,distance(cameraPosition,(modelMatrix*vec4(position,1.0)).xyz));
...
vLightDir=vLightPosition-mvPosition.xyz;
...
// БЛЕСК ПО ФОНГУ
vec3 power=LightingFuncGGX_REF(normal,V,L,0.4,0.025);
finalColor+=power;
